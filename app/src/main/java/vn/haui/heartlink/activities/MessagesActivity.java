...
/**
 * Displays the Messages tab with active matches and existing chat threads.
 */
public class MessagesActivity extends AppCompatActivity implements
    ...
    /**
     * Phương thức khởi tạo activity hiển thị danh sách tin nhắn và chat threads.
     * Thiết lập giao diện và tải dữ liệu tin nhắn.
     *
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rootView = findViewById(R.id.messages_root);
        ViewCompat.setOnApplyWindowInsetsListener(rootView, (view, windowInsets) -> {
            Insets insets = windowInsets.getInsets(WindowInsetsCompat.Type.systemBars());
            view.setPadding(view.getPaddingLeft(), insets.top, view.getPaddingRight(), Math.max(view.getPaddingBottom(), insets.bottom));
            return windowInsets;
        });
    ...
    private void bindViews() {
        activeUsersList = findViewById(R.id.messages_active_list);
        threadsList = findViewById(R.id.messages_threads_list);
        loadingIndicator = findViewById(R.id.messages_loading);
        emptyStateView = findViewById(R.id.messages_empty_state);
        searchField = findViewById(R.id.messages_search);
        activeLabel = findViewById(R.id.messages_active_label);
        threadsLabel = findViewById(R.id.messages_threads_label);
    }

    /**
     * Phương thức thiết lập các RecyclerView cho active users và message threads.
     */
    private void setupRecyclerViews() {
        activeUsersAdapter = new ActiveUsersAdapter(this);
        activeUsersList.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        activeUsersList.setAdapter(activeUsersAdapter);

        threadsAdapter = new MessageThreadsAdapter(this);
        threadsList.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void setupClicks() {
        ImageButton backButton = findViewById(R.id.messages_back_button);
        ImageButton filterButton = findViewById(R.id.messages_filter_button);
    ...
    /**
     * Phương thức tải nội dung chính bao gồm interactions và threads.
     */
    ...
    /**
     * Phương thức làm mới danh sách active users từ interactions.
     */
    ...
    /**
     * Phương thức làm mới danh sách message threads.
     */
    ...
    /**
     * Phương thức gắn listener để lắng nghe thay đổi của message threads.
     */
    ...
    /**
     * Phương thức gỡ bỏ listener của message threads.
     */
    ...
    /**
     * Phương thức tải thông tin profile của partner.
     *
     * @param partnerUid UID của partner
     */
    ...
    /**
     * Phương thức thiết lập trạng thái loading.
     *
    ...
    /**
     * Phương thức cập nhật trạng thái loading dựa trên các tác vụ đang chạy.
     */
    ...
    @Override
    /**
     * Phương thức callback khi người dùng click vào active user.
     *
     * @param item PartnerItem được click
     */
    ...
    @Override
    /**
     * Phương thức callback khi người dùng click vào message thread.
     *
     * @param item ThreadItem được click
     */
    ...
    /**
     * Phương thức mở màn hình chat với partner.
     *
     * @param partnerUid UID của partner
     * @param displayName Tên hiển thị của partner
     * @param photoUrl URL ảnh của partner
     */
